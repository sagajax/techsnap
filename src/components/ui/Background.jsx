...
const BackgroundDots = ({
    ...
    const maskStyle = fade
        ? {
            maskImage: 'radial-gradient(circle at 50% 50%, white 30%, transparent 90%)',
WebkitMaskImage: 'radial-gradient(circle at 50% 50%, white 30%, transparent 90%)'
        }
        : {};
    ...
    return (
        <div
            className={`absolute z-[0] inset-0 h-full w-full ${className}`}
